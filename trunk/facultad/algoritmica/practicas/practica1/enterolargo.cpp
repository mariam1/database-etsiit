...
if(entero.size()<=2){
	...
	enterolargo u = x1.dyv_multiplicacion(y1);
	enterolargo v = y2.dyv_multiplicacion(y2);
	enterolargo w = x.dyv_multiplicacion(y);
	...
	cout << "uSUMAv: " << uSUMAv << endl;
	cout << " wRESTAuv: " << wRESTAuv << endl;
	cout << "z: " << z << endl;
	cout << "resul: " << resul << endl;
